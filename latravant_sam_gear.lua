...
function init_gear_sets()
    ...
    sets.precast.WS = {    main={ name="Kurikaranotachi", augments={'Accuracy+70','Weapon skill damage +5%','"Dbl.Atk."+5',}},
    sub="Dilet.'s Grip +1",
    ammo="Hasty Pinion +1",
    head="Hiza. Somen +2",
    body="Dagon Breast.",
    ...
    back={ name="Smertrios's Mantle", augments={'STR+20','Accuracy+1 Attack+1',}},
	}
    ...
    sets.idle = {    ammo="Aurgelmir Orb",
		...
		legs={ name="Valorous Hose", augments={'VIT+8','Crit.hit rate+1','Weapon skill damage +2%','Accuracy+2 Attack+2','Mag. Acc.+13 "Mag.Atk.Bns."+13',}},
		feet={ name="Amm Greaves", augments={'HP+35','VIT+8',}},
